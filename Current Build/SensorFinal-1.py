#!/usr/bin/env python
# pylint: disable=unused-import, unused-wildcard-import, no-self-argument

"""
Static Sensor Plot
-----------------
Recieves data from SensorLive, and plots filled-data.
"""
...
class SensorFinal(object):
    ...
    def widget_init(self):
        """
        Initializes all widgets and returns them
        """
